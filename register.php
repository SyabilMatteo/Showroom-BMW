...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Simpan ke database
    $sql = "INSERT INTO pengguna (nama, email, no_telepon, password, alamat, foto_profil, tanggal_daftar)
    ...
    <div class="mt-32 flex flex-col justify-start items-center w-full max-w-md">
      ...
      <form method="POST" enctype="multipart/form-data" class="w-full max-w-md pb-10">
          <div class="mb-4">
              ...
              <input type="text" id="username" name="username" required placeholder="Justice Suelai"
          ...
          <div class="flex flex-col md:flex-row md:gap-4 mb-4">
              <div class="w-full">
                  ...
                  <input type="email" id="email" name="email" required placeholder="justice@email.com"
                         class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
              </div>
              <div class="w-full">
          ...
          <div class="mb-4">
              ...
              <textarea id="address" name="address" rows="3" required placeholder="Jl. Merdeka No. 45, Jakarta"
